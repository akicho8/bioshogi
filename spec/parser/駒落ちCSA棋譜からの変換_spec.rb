...
EOT
    ...
    it "表記が間違っている" do
      expect { Bioshogi::Parser.parse("V2.2,PI82HI22OU").to_csa }.to raise_error(Bioshogi::SyntaxDefact)
    end
  end

  describe "(3) 駒別単独表現" do
    it "works" do
      Bioshogi::Parser.parse("V2.2,P-51OU,P+53KI00GI,P-00AL,-,-5141OU,+0052GI").to_csa == <<~EOT
V2.2
P1 *  *  *  * -OU *  *  *  *
P2 *  *  *  *  *  *  *  *  *
P3 *  *  *  * +KI *  *  *  *
