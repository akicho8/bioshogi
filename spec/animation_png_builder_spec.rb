...
module Bioshogi
  describe AnimationPngBuilder do
    it "works" do
      info = Parser.parse("position startpos moves 7g7f 8c8d")
      bin = info.to_animation_png(one_frame_duration_sec: 0.5, end_frames: 0)
...
# >> .
# >> 
# >> Finished in 2.71 seconds (files took 1.29 seconds to load)
