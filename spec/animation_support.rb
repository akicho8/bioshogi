...
module AnimationSupport
  ...
  def target1(ext_name, method, params = {})
    ...
    bin = info.send(method, cover_text: "(cover_text)", page_duration: 0.5, end_duration: 1, width: 2, height: 2, audio_theme_key: "is_audio_theme_ds3479", turn_embed_key: "is_turn_embed_on", **params)
