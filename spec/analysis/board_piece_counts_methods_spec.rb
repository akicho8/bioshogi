...
module Bioshogi
  module Analysis
    describe BoardPieceCountsMethods do
...
# >>      # -:11:in `block (3 levels) in <module:Bioshogi>'
# >>      # -:11:in `block (2 levels) in <module:Bioshogi>'
# >>
# >> Top 2 slowest examples (0.01914 seconds, 58.6% of total time):
# >>   Bioshogi::Board::BoardPieceCountsMethods piece_counts
# >>     0.0175 seconds -:5
# >>   Bioshogi::Board::BoardPieceCountsMethods location_piece_counts
# >>     0.00164 seconds -:9
# >>
# >> Finished in 0.03265 seconds (files took 2.8 seconds to load)
