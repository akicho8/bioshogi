...
module Bioshogi
  describe ImageRenderer do
    it do
      ...
      object = parser.image_renderer(width: 100, height: 100, viewpoint: "black", image_format: "png")
    ...
    it "theme" do
      ...
      object = parser.image_renderer(theme: "dark_mode")
    ...
    #     parser.image_renderer(width: 100, height: 100, flip: true)
    #   end
    # end
  end
end
