...
RSpec.describe Bioshogi::Place do
  ...
  it "zero" do
    assert { Bioshogi::Place.zero.name == "９一" }
  end
  ...
  it "vector_to" do
    assert { Bioshogi::Place["55"].vector_to(Bioshogi::Place["56"]) == Bioshogi::V.down  }
    assert { Bioshogi::Place["55"].vector_to(Bioshogi::Place["54"]) == Bioshogi::V.up    }
    assert { Bioshogi::Place["55"].vector_to(Bioshogi::Place["45"]) == Bioshogi::V.right }
    assert { Bioshogi::Place["55"].vector_to(Bioshogi::Place["65"]) == Bioshogi::V.left  }
  end
