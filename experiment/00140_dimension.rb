...
Dimension::Xplace.fetch("１").object_id == Dimension::Xplace.fetch("１").object_id # => true

instance = Dimension::Xplace.fetch("１")
instance.name           # => "１"
instance.value          # => 8
...
instance = Dimension::Yplace.fetch("１")
instance.name           # => "一"
instance.value          # => 0
instance.hankaku_number # => "1"
instance.zenkaku_number # => "１"
...
test.(Dimension::Xplace)
test.(Dimension::Yplace)
# >> |------+-------+----------------+----------------+---------+--------------+---------|
