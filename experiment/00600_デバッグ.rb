...
handicap_info = HandicapInfo["平手"].both_board_info[Location[:black]]
...
handicap_info.sort.collect(&:name)     # => ["９七歩", "９九香", "８七歩", "８八角", "８九桂", "７七歩", "７九銀", "６七歩", "６九金", "５七歩", "５九玉", "４七歩", "４九金", "３七歩", "３九銀", "２七歩", "２八飛", "２九桂", "１七歩", "１九香"]

soldiers.sort == handicap_info.sort # => false

soldiers.sort.first        # => {:piece=><Bushido::Piece:70168203774880 歩 pawn>, :promoted=>false, :point=>#<Bushido::Point:70168202530940 "９七">}
handicap_info.sort.first            # => {:piece=><Bushido::Piece:70168203774880 歩 pawn>, :promoted=>false, :point=>#<Bushido::Point:70168202530940 "９七">, :location=>#<Bushido::Location:0x007fa29dbcb758 @attributes={:key=>:black, :name=>"先手", :mark=>"▲", :reverse_mark=>"▼", :other_match_chars=>["上手", "☗", "b"], :varrow=>" ", :angle=>0, :csa_sign=>"+", :code=>0}, @match_target_values_set=#<Set: {:black, "▲", "▼", "上手", "☗", "b", "先手", "先", 0, " ", "+"}>>}
