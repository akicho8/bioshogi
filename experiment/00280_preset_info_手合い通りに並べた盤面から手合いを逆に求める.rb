...
PresetInfo.each do |preset_info|
  ...
  Location.each do |location|
    ...
    soldiers = soldiers.collect(&:half_rotate_if_white).sort
    e = PresetInfo.find do |e|
      e.location_split[:black] == soldiers
    end
    tp e.key # => :平手, :平手, :平手, :香落ち, :平手, :右香落ち, :平手, :角落ち, :平手, :飛車落ち, :平手, :飛香落ち, :平手, :二枚落ち, :平手, :三枚落ち, :平手, :四枚落ち, :平手, :六枚落ち, :平手, :八枚落ち, :平手, :十枚落ち, :平手, :十九枚落ち, :平手, :二十枚落ち
  end
end
# >>   ９ ８ ７ ６ ５ ４ ３ ２ １
# >> +---------------------------+
