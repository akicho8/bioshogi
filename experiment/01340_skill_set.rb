...
skill_set.defense_infos.normalized_tactics.collect(&:key)                        # => [:ダイヤモンド美濃, :坊主美濃]
skill_set.defense_infos.normalized_tactics.flat_map {|e|[e.key, *e.alias_names]} # => [:ダイヤモンド美濃, :坊主美濃, "大山美濃"]
