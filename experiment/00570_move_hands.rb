...
Board.dimensiton_change([2, 3]) do
  ...
  mediator.current_player.move_hands(promoted_only: true).collect(&:to_s)  # => ["△２二玉(11)", "△２一玉(11)", "△２三角成(12)", "△２一角成(12)"]
  mediator.current_player.move_hands(promoted_only: false).collect(&:to_s) # => ["△２二玉(11)", "△２一玉(11)", "△２三角成(12)", "△２三角(12)", "△２一角成(12)", "△２一角(12)"]
