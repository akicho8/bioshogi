...
info.mediator.to_short_sfen # => "sfen lnsgkgsnl/1r5b1/ppppppppp/9/9/9/PPPPPPPPP/1B1S3R1/LN1GKGSNL w - 2"

# ▼サーバーレス将棋 AI ☖ - Qiita
# https://qiita.com/na-o-ys/items/b04ce27732c82b6beb9b

require "faraday"
url = "https://17xn1ovxga.execute-api.ap-northeast-1.amazonaws.com/production/gikou?byoyomi=10000&dimension=#{URI.escape(info.mediator.to_short_sfen)}"
