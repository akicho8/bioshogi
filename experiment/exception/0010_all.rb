...
Xcontainer.start.execute("58金") rescue $!                 # => #<Bioshogi::AmbiguousFormatError: ５八に移動できる駒が2つありますが表記が曖昧なため特定できません。移動元は「６九の金」か「４九の金」のどっちでしょう？
Xcontainer.start.execute("58金上") rescue $!               # => #<Bioshogi::AmbiguousFormatError: ５八に移動できる駒が2つありますが「上」からは特定できません。移動元は「６九の金」か「４九の金」のどっちでしょう？
