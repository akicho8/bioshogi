...
# >> | 富士見矢倉           | 囲い/富士見矢倉.kif           | [:銀雲雀, :金矢倉, :富士見矢倉]                                                        | true   |
...
# >> | かまいたち戦法       | 戦型/かまいたち戦法.kif       | [:四間飛車, :５筋位取り, :かまいたち戦法, :相振り飛車, :対振り持久戦]                  | true   |
...
# >> | 相入玉               | 備考/相入玉.kif               | [:入玉, :相入玉, :居飛車, :相居飛車, :入玉, :相入玉, :居飛車, :相居飛車]               | true   |
# >> | 大駒全消失           | 備考/大駒全消失.kif           | [:大駒コンプリート, :居飛車, :対振り, :対抗型, :居玉, :振り飛車, :大駒全消失, :対抗型] | true   |
...
# >> | 大駒コンプリート     | 備考/大駒コンプリート.kif     | [:大駒コンプリート, :居飛車, :対振り, :対抗型, :居玉, :振り飛車, :大駒全消失, :対抗型] | true   |
