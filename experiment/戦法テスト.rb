...
# >> |----------------------+-------------------------------+-----------------------------------------------------------------------------------------------------+--------|
# >> | 天守閣囲い           | 囲い/天守閣囲い.kif           | [:天守閣囲い, :片美濃囲い]                                                                          | true   |
# >> | 居玉                 | 囲い/居玉.kif                 | [:居玉, :居玉]                                                                                      | true   |
# >> | カニ囲い             | 囲い/カニ囲い.kif             | [:カニ囲い]                                                                                         | true   |
# >> | カブト囲い           | 囲い/カブト囲い.kif           | [:カブト囲い, :居玉]                                                                                | true   |
# >> | 金矢倉               | 囲い/金矢倉.kif               | [:金矢倉, :角矢倉, :居玉]                                                                           | true   |
# >> | 銀矢倉               | 囲い/銀矢倉.kif               | [:銀矢倉, :居玉]                                                                                    | true   |
# >> | 角矢倉               | 囲い/角矢倉.kif               | [:カブト囲い, :角矢倉, :カブト囲い]                                                                 | true   |
# >> | 隅矢倉               | 囲い/隅矢倉.kif               | [:カニ囲い, :金矢倉, :隅矢倉, :金矢倉]                                                              | true   |
# >> | 矢倉右玉             | 囲い/矢倉右玉.kif             | [:矢倉右玉]                                                                                         | true   |
# >> | 流れ矢倉             | 囲い/流れ矢倉.kif             | [:カニ囲い, :流れ矢倉]                                                                              | true   |
# >> | 四角矢倉             | 囲い/四角矢倉.kif             | [:四角矢倉]                                                                                         | true   |
# >> | へこみ矢倉           | 囲い/へこみ矢倉.kif           | [:金門矢倉, :へこみ矢倉]                                                                            | true   |
# >> | カタ囲い             | 囲い/カタ囲い.kif             | [:坊主美濃, :右矢倉, :カタ囲い]                                                                     | true   |
# >> | 悪形矢倉             | 囲い/悪形矢倉.kif             | [:悪形矢倉]                                                                                         | true   |
# >> | 天野矢倉             | 囲い/天野矢倉.kif             | [:天野矢倉]                                                                                         | true   |
# >> | 総矢倉               | 囲い/総矢倉.kif               | [:総矢倉]                                                                                           | true   |
# >> | 金門矢倉             | 囲い/金門矢倉.kif             | [:金門矢倉]                                                                                         | true   |
...
# >> | カニ缶囲い           | 囲い/カニ缶囲い.kif           | [:カニ缶囲い]                                                                                       | true   |
# >> | オリジナル雁木       | 囲い/オリジナル雁木.kif       | [:オリジナル雁木, :美濃囲い]                                                                        | true   |
# >> | オールド雁木         | 囲い/オールド雁木.kif         | [:総矢倉, :オールド雁木]                                                                            | true   |
# >> | ツノ銀雁木           | 囲い/ツノ銀雁木.kif           | [:ツノ銀雁木]                                                                                       | true   |
# >> | 新型雁木             | 囲い/新型雁木.kif             | [:新型雁木]                                                                                         | true   |
# >> | 右玉                 | 囲い/右玉.kif                 | [:カブト囲い, :銀矢倉, :右玉]                                                                       | true   |
# >> | 糸谷流右玉           | 囲い/糸谷流右玉.kif           | [:糸谷流右玉]                                                                                       | true   |
# >> | 羽生流右玉           | 囲い/羽生流右玉.kif           | [:羽生流右玉]                                                                                       | true   |
# >> | 角換わり右玉         | 囲い/角換わり右玉.kif         | [:矢倉右玉, :角換わり右玉]                                                                          | true   |
# >> | 雁木右玉             | 囲い/雁木右玉.kif             | [:新型雁木, :雁木右玉]                                                                              | true   |
# >> | ツノ銀型右玉         | 囲い/ツノ銀型右玉.kif         | [:ツノ銀雁木, :ツノ銀雁木, :ツノ銀型右玉]                                                           | true   |
...
# >> | 振り飛車エルモ       | 囲い/振り飛車エルモ.kif       | [:振り飛車エルモ, :居玉]                                                                            | true   |
...
# >> | 裾固め               | 囲い/裾固め.kif               | [:居玉, :木村美濃, :裾固め]                                                                         | true   |
...
# >> | 桐山流中原囲い       | 囲い/桐山流中原囲い.kif       | [:桐山流中原囲い, :居玉]                                                                            | true   |
...
# >> | あずまや囲い         | 囲い/あずまや囲い.kif         | [:あずまや囲い, :居玉, :無敵囲い, :居玉]                                                            | true   |
...
# >> | 力戦                 | 戦型/力戦.kif                 | [:力戦, :力戦]                                                                                      | true   |
# >> | ノーガード戦法       | 戦型/ノーガード戦法.kif       | [:ノーガード戦法, :力戦]                                                                            | true   |
...
# >> | 米長流急戦矢倉       | 戦型/米長流急戦矢倉.kif       | [:米長流急戦矢倉, :力戦]                                                                            | true   |
# >> | カニカニ銀           | 戦型/カニカニ銀.kif           | [:カニカニ銀, :右四間飛車]                                                                          | true   |
# >> | カニカニ金           | 戦型/カニカニ金.kif           | [:カニカニ金, :矢倉中飛車, :ゴキゲン中飛車, :原始中飛車, :力戦]                                     | true   |
...
# >> | 原始棒銀             | 戦型/原始棒銀.kif             | [:原始棒銀, :棒銀, :力戦]                                                                           | true   |
...
# >> | 稲庭戦法             | 戦型/稲庭戦法.kif             | [:嬉野流, :稲庭戦法, :力戦]                                                                         | true   |
# >> | 四手角               | 戦型/四手角.kif               | [:森下システム, :四手角]                                                                            | true   |
# >> | 一間飛車             | 戦型/一間飛車.kif             | [:一間飛車, :力戦]                                                                                  | true   |
# >> | 一間飛車穴熊         | 戦型/一間飛車穴熊.kif         | [:一間飛車穴熊, :力戦]                                                                              | true   |
# >> | 都成流               | 戦型/都成流.kif               | [:力戦, :都成流]                                                                                    | true   |
# >> | 右四間飛車左美濃     | 戦型/右四間飛車左美濃.kif     | [:力戦, :右四間飛車, :右四間飛車左美濃]                                                             | true   |
# >> | 角換わり             | 戦型/角換わり.kif             | [:角交換振り飛車, :角換わり, :力戦]                                                                 | true   |
# >> | 角換わり腰掛け銀     | 戦型/角換わり腰掛け銀.kif     | [:角換わり早繰り銀, :角換わり腰掛け銀, :右四間飛車]                                                 | true   |
# >> | 角換わり棒銀         | 戦型/角換わり棒銀.kif         | [:原始棒銀, :角換わり棒銀, :棒銀, :力戦]                                                            | true   |
...
# >> | 相掛かり             | 戦型/相掛かり.kif             | [:相掛かり, :相掛かり棒銀, :力戦]                                                                   | true   |
# >> | 相掛かり棒銀         | 戦型/相掛かり棒銀.kif         | [:相掛かり, :相掛かり棒銀, :力戦]                                                                   | true   |
# >> | 塚田スペシャル       | 戦型/塚田スペシャル.kif       | [:相掛かり, :塚田スペシャル, :力戦]                                                                 | true   |
...
# >> | 新石田流             | 戦型/新石田流.kif             | [:三間飛車, :新石田流, :力戦]                                                                       | true   |
# >> | 新鬼殺し             | 戦型/新鬼殺し.kif             | [:力戦, :新鬼殺し]                                                                                  | true   |
# >> | ダイレクト向かい飛車 | 戦型/ダイレクト向かい飛車.kif | [:力戦, :カメレオン戦法, :ダイレクト向かい飛車]                                                     | true   |
# >> | 向かい飛車           | 戦型/向かい飛車.kif           | [:力戦, :向かい飛車]                                                                                | true   |
# >> | メリケン向かい飛車   | 戦型/メリケン向かい飛車.kif   | [:向かい飛車, :メリケン向かい飛車, :対振り持久戦]                                                   | true   |
# >> | 阪田流向飛車         | 戦型/阪田流向飛車.kif         | [:力戦, :ダイレクト向かい飛車, :阪田流向飛車]                                                       | true   |
# >> | 角頭歩戦法           | 戦型/角頭歩戦法.kif           | [:角頭歩戦法]                                                                                       | true   |
# >> | 鬼殺し向かい飛車     | 戦型/鬼殺し向かい飛車.kif     | [:丸山ワクチン, :角換わり, :ゴキゲン中飛車, :鬼殺し向かい飛車]                                      | true   |
# >> | 陽動振り飛車         | 戦型/陽動振り飛車.kif         | [:力戦, :矢倉中飛車, :ゴキゲン中飛車, :陽動振り飛車]                                                | true   |
# >> | 玉頭銀               | 戦型/玉頭銀.kif               | [:力戦, :玉頭銀, :原始棒銀, :棒銀]                                                                  | true   |
# >> | つくつくぼうし戦法   | 戦型/つくつくぼうし戦法.kif   | [:つくつくぼうし戦法, :力戦]                                                                        | true   |
# >> | ひねり飛車           | 戦型/ひねり飛車.kif           | [:相掛かり, :ひねり飛車, :力戦]                                                                     | true   |
# >> | 耀龍ひねり飛車       | 戦型/耀龍ひねり飛車.kif       | [:耀龍ひねり飛車]                                                                                   | true   |
# >> | 相振り飛車           | 戦型/相振り飛車.kif           | [:ゴキゲン中飛車, :相振り飛車, :四間飛車]                                                           | true   |
# >> | 角交換振り飛車       | 戦型/角交換振り飛車.kif       | [:力戦, :角交換振り飛車]                                                                            | true   |
# >> | はく式四間飛車       | 戦型/はく式四間飛車.kif       | [:はく式四間飛車, :力戦]                                                                            | true   |
...
# >> | 棒銀                 | 戦型/棒銀.kif                 | [:原始棒銀, :角換わり棒銀, :棒銀, :力戦]                                                            | true   |
...
# >> | 裏アヒル戦法         | 戦型/裏アヒル戦法.kif         | [:目くらまし戦法, :裏アヒル戦法, :力戦]                                                             | true   |
# >> | 矢倉左美濃急戦       | 戦型/矢倉左美濃急戦.kif       | [:力戦, :矢倉左美濃急戦]                                                                            | true   |
# >> | 青野流               | 戦型/青野流.kif               | [:横歩取り, :青野流, :△３三角型空中戦法]                                                           | true   |
# >> | 勇気流               | 戦型/勇気流.kif               | [:横歩取り, :勇気流, :△３三角型空中戦法]                                                           | true   |
# >> | 極限早繰り銀         | 戦型/極限早繰り銀.kif         | [:極限早繰り銀, :力戦]                                                                              | true   |
# >> | トマホーク           | 戦型/トマホーク.kif           | [:三間飛車, :トマホーク, :対振り持久戦]                                                             | true   |
# >> | 羽生式袖飛車         | 戦型/羽生式袖飛車.kif         | [:UFO銀, :羽生式袖飛車]                                                                             | true   |
# >> | 初手７八銀戦法       | 戦型/初手７八銀戦法.kif       | [:初手７八銀戦法, :力戦]                                                                            | true   |
# >> | 初手３六歩戦法       | 戦型/初手３六歩戦法.kif       | [:初手３六歩戦法]                                                                                   | true   |
# >> | きんとうん戦法       | 戦型/きんとうん戦法.kif       | [:きんとうん戦法, :力戦]                                                                            | true   |
...
# >> | カメレオン戦法       | 戦型/カメレオン戦法.kif       | [:カメレオン戦法, :力戦]                                                                            | true   |
...
# >> | 銀冠の小部屋         | 手筋/銀冠の小部屋.kif         | [:銀冠の小部屋]                                                                                     | true   |
# >> | 入玉                 | 備考/入玉.kif                 | [:入玉, :相入玉, :居飛車, :相居飛車, :入玉, :相入玉, :居飛車, :相居飛車]                            | true   |
# >> | 角不成               | 備考/角不成.kif               | [:角不成, :角不成, :居飛車, :相居飛車, :居飛車, :相居飛車]                                          | true   |
# >> | 飛車不成             | 備考/飛車不成.kif             | [:居飛車, :飛車不成, :相居飛車, :居飛車, :相居飛車]                                                 | true   |
# >> | 居飛車               | 備考/居飛車.kif               | [:居飛車, :相居飛車, :居飛車, :相居飛車]                                                            | true   |
# >> | 振り飛車             | 備考/振り飛車.kif             | [:振り飛車, :対抗型, :居飛車, :対振り, :対抗型]                                                     | true   |
# >> | 相入玉               | 備考/相入玉.kif               | [:入玉, :相入玉, :居飛車, :相居飛車, :入玉, :相入玉, :居飛車, :相居飛車, :背水の陣]                 | true   |
# >> | 大駒全消失           | 備考/大駒全消失.kif           | [:大駒コンプリート, :居飛車, :対振り, :対抗型, :振り飛車, :大駒全消失, :対抗型, :背水の陣]          | true   |
# >> | 相居玉               | 備考/相居玉.kif               | [:居飛車, :対振り, :対抗型, :相居玉, :振り飛車, :対抗型, :相居玉]                                   | true   |
# >> | 背水の陣             | 備考/背水の陣.kif             | [:振り飛車, :大駒全消失, :相振り, :背水の陣, :大駒コンプリート, :振り飛車, :相振り]                 | true   |
# >> | 相居飛車             | 備考/相居飛車.kif             | [:居飛車, :相居飛車, :居飛車, :相居飛車]                                                            | true   |
# >> | 対振り               | 備考/対振り.kif               | [:振り飛車, :対抗型, :居飛車, :対振り, :対抗型]                                                     | true   |
# >> | 相振り               | 備考/相振り.kif               | [:振り飛車, :相振り, :振り飛車, :相振り]                                                            | true   |
# >> | 対抗型               | 備考/対抗型.kif               | [:振り飛車, :対抗型, :居飛車, :対振り, :対抗型]                                                     | true   |
# >> | 大駒コンプリート     | 備考/大駒コンプリート.kif     | [:大駒コンプリート, :居飛車, :対振り, :対抗型, :振り飛車, :大駒全消失, :対抗型, :背水の陣]          | true   |
# >> | 駒柱                 | 備考/駒柱.kif                 | [:振り飛車, :駒柱, :相振り, :相居玉, :振り飛車, :駒柱, :相振り, :相居玉]                            | true   |
# >> |----------------------+-------------------------------+-----------------------------------------------------------------------------------------------------+--------|
