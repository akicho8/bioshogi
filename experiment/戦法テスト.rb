...
# >> | カニ缶囲い           | 囲い/カニ缶囲い.kif           | [:カニ缶囲い, :居玉]                                                                                | true   |
...
# >> | 雁木右玉             | 囲い/雁木右玉.kif             | [:雁木右玉]                                                                                         | true   |
# >> | ツノ銀型右玉         | 囲い/ツノ銀型右玉.kif         | [:ツノ銀雁木, :ツノ銀型右玉]                                                                        | true   |
...
# >> | 早囲い               | 囲い/早囲い.kif               | [:早囲い, :居玉]                                                                                    | true   |
# >> | 三手囲い             | 囲い/三手囲い.kif             | [:三手囲い, :居玉]                                                                                  | true   |
# >> | ずれ美濃             | 囲い/ずれ美濃.kif             | [:早囲い, :ずれ美濃, :居玉]                                                                         | true   |
...
# >> | ノーガード戦法       | 戦型/ノーガード戦法.kif       | [:ノーガード戦法]                                                                                   | true   |
...
# >> | 飛車不成             | 備考/飛車不成.kif             | [:居飛車, :飛車不成, :相居飛車, :相居玉, :居飛車, :相居飛車, :相居玉]                               | true   |
# >> | 居飛車               | 備考/居飛車.kif               | [:居飛車, :相居飛車, :相居玉, :居飛車, :相居飛車, :相居玉]                                          | true   |
# >> | 振り飛車             | 備考/振り飛車.kif             | [:振り飛車, :対抗型, :相居玉, :居飛車, :対振り, :対抗型, :相居玉]                                   | true   |
# >> | 相入玉               | 備考/相入玉.kif               | [:入玉, :相入玉, :居飛車, :相居飛車, :入玉, :相入玉, :居飛車, :相居飛車, :背水の陣]                 | true   |
# >> | 大駒全消失           | 備考/大駒全消失.kif           | [:大駒コンプリート, :居飛車, :対振り, :対抗型, :振り飛車, :大駒全消失, :対抗型, :背水の陣]          | true   |
# >> | 相居玉               | 備考/相居玉.kif               | [:居飛車, :相居飛車, :相居玉, :居飛車, :相居飛車, :相居玉]                                          | true   |
# >> | 背水の陣             | 備考/背水の陣.kif             | [:振り飛車, :大駒全消失, :相振り, :背水の陣, :大駒コンプリート, :振り飛車, :相振り]                 | true   |
# >> | 相居飛車             | 備考/相居飛車.kif             | [:居飛車, :相居飛車, :相居玉, :居飛車, :相居飛車, :相居玉]                                          | true   |
# >> | 対振り               | 備考/対振り.kif               | [:振り飛車, :対抗型, :相居玉, :居飛車, :対振り, :対抗型, :相居玉]                                   | true   |
# >> | 相振り               | 備考/相振り.kif               | [:振り飛車, :相振り, :相居玉, :振り飛車, :相振り, :相居玉]                                          | true   |
# >> | 対抗型               | 備考/対抗型.kif               | [:振り飛車, :対抗型, :相居玉, :居飛車, :対振り, :対抗型, :相居玉]                                   | true   |
