...
bin = info.to_mp4(page_duration: 1.0, tmpdir_remove: true, audio_theme_key: :audio_theme_is_none, factory_method_key: "rmagick")
...
# >> [mp4_builder] [video] 合計フレーム数(page_count): 13
