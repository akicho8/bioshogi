...
bin = info.to_animation_mp4(page_duration: 1.0, tmpdir_remove: true, audio_theme_key: :is_audio_theme_none, factory_method_key: "is_factory_method_rmagick")
...
# >> [animation_mp4_builder] cd /var/folders/9c/_62dfc8502g_d5r05zyfwlxh0000gn/T/d20210820-78451-x1y9ko
# >> [animation_mp4_builder] [video] 最後に追加するフレーム数(end_pages): 0
# >> [animation_mp4_builder] [video] 1手当たりの秒数(page_duration): 1.0
# >> [animation_mp4_builder] [video] move: 0 / 12
# >> [animation_mp4_builder] [video] move: 10 / 12
# >> [animation_mp4_builder] [video] 合計フレーム数(page_count): 13
# >> [animation_mp4_builder] [video] -rw-r--r-- 1 ikeda staff 29K  8 20 13:24 _input000.png
...
# >> [animation_mp4_builder] [video] write[begin]: _output1.mp4 (ffmpeg)
# >> [animation_mp4_builder] [video] [execute] ffmpeg -v warning -hide_banner -framerate 1000/1000 -i _input%03d.png -c:v libx264 -pix_fmt yuv420p -movflags +faststart  -y _output1.mp4
# >> [animation_mp4_builder] [video] [execute] elapsed: 2s
# >> [animation_mp4_builder] [video] write[end]: _output1.mp4 (ffmpeg)
# >> [animation_mp4_builder] [video] -rw-r--r-- 1 ikeda staff 90K  8 20 13:24 _output1.mp4
# >> [animation_mp4_builder] rm -fr /var/folders/9c/_62dfc8502g_d5r05zyfwlxh0000gn/T/d20210820-78451-x1y9ko
