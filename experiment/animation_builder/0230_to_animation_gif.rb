...
bin = info.to_animation_gif(page_duration: 0.5, factory_method_key: "is_factory_method_rmagick", tmpdir_remove: false, color_theme_key: "is_color_theme_real_wood1")
Pathname("_output_rmagick.gif").write(bin) # => 161024
puts `identify _output_rmagick.gif`

bin = info.to_animation_gif(page_duration: 0.5, factory_method_key: "is_factory_method_ffmpeg", tmpdir_remove: false, color_theme_key: "is_color_theme_real_wood1")
