...
# >> [Mp4Builder] [video] 2021-09-15 08:53:04 2/14  14.29 % T0 終了図 1
# >> [Mp4Builder] [video] 2021-09-15 08:53:04 3/14  21.43 % T0 終了図 2
...
# >> [Mp4Builder] [video] -rw-r--r-- 1 ikeda staff 65K  9 15 08:53 _output1.mp4
...
# >> [Mp4Builder] 2021-09-15 08:53:05 8/14  57.14 % T1 メタデータ埋め込み
# >> [Mp4Builder] [execute] ffmpeg -v warning -hide_banner -i _output1.mp4 -metadata title="0\手\目\ま\で\の\棋\譜" -metadata comment="position\ startpos" -codec copy -y _output2.mp4
...
# >> [Mp4Builder] [audio] 2021-09-15 08:53:06 9/14  64.29 % T0 フェイドアウトと音量調整
...
# >> [Mp4Builder] 3. 結合
# >> [Mp4Builder] 2021-09-15 08:53:07 10/14  71.43 % T1 BGM結合
# >> [Mp4Builder] [execute] ffmpeg -v warning -i _output2.mp4 -i _same_length1.m4a -c copy -y _output3.mp4
# >> [Mp4Builder] [execute] elapsed: 1s
# >> [Mp4Builder] rm -fr /var/folders/9c/_62dfc8502g_d5r05zyfwlxh0000gn/T/d20210915-52373-1aqjjn6
...
# >> [Mp4Builder] [video] [0] transparent_layer create for d_piece_count_layer END
# >> [Mp4Builder] [video] [0] composite process
# >> [Mp4Builder] [video] 2021-09-15 08:53:10 2/14  14.29 % T0 終了図 1
# >> [Mp4Builder] [video] 2021-09-15 08:53:10 3/14  21.43 % T0 終了図 2
...
# >> [Mp4Builder] [video] [clear_all] @d_piece_count_layer.destroy!
# >> [Mp4Builder] [video] [clear_all] @last_rendered_image.destroy!
# >> [Mp4Builder] 2021-09-15 08:53:11 8/14  57.14 % T1 メタデータ埋め込み
# >> [Mp4Builder] [execute] ffmpeg -v warning -hide_banner -i _output1.mp4 -metadata title="0\手\目\ま\で\の\棋\譜" -metadata comment="position\ startpos" -codec copy -y _output2.mp4
# >> [Mp4Builder] [execute] elapsed: 1s
# >> [Mp4Builder] [audio] 2. BGM準備
# >> [Mp4Builder] [audio] 予測した全体の秒数(total_duration): 6.0
# >> [Mp4Builder] [audio] 開戦前のみ
# >> [Mp4Builder] [audio] audio_part_x: /Users/ikeda/src/bioshogi/lib/bioshogi/assets/audios/headspin_long.m4a
# >> [Mp4Builder] [audio] 2021-09-15 08:53:12 9/14  64.29 % T0 フェイドアウトと音量調整
# >> [Mp4Builder] [audio] [execute] ffmpeg -v warning -stream_loop -1 -i /Users/ikeda/src/bioshogi/lib/bioshogi/assets/audios/headspin_long.m4a -t 6.0 -af volume=0.7,afade=t=out:start_time=1.0:duration=5.0  -y _same_length1.m4a
# >> [Mp4Builder] [audio] [execute] elapsed: 1s
# >> [Mp4Builder] [audio] headspin_long.m4a: 28.049705
# >> [Mp4Builder] [audio] fadeout_duration: 5.0
# >> [Mp4Builder] 3. 結合
# >> [Mp4Builder] 2021-09-15 08:53:13 10/14  71.43 % T1 BGM結合
# >> [Mp4Builder] [execute] ffmpeg -v warning -i _output2.mp4 -i _same_length1.m4a -c copy -y _output3.mp4
# >> [Mp4Builder] [execute] elapsed: 1s
# >> [Mp4Builder] rm -fr /var/folders/9c/_62dfc8502g_d5r05zyfwlxh0000gn/T/d20210915-52373-tlfzfz
# >> "87.044000 Kbit/s 129.050000 Kbit/s"
