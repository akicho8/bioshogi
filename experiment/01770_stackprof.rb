...
# >>         15   (1.6%)          12   (1.3%)     Bioshogi::Dimension::Xplace#hankaku_number
# >>         12   (1.3%)          11   (1.2%)     Bioshogi::Dimension::Yplace#hankaku_number
...
# >>                                   |    89  |         # 手番限定。手番が異なればskip
# >>                                   |    90  |         if e.order_key
# >>                                   |    91  |           if e.order_key != player.mediator.turn_info.order_key
# >>                                   |    92  |             throw :skip
# >>                                   |    93  |           end
# >>                                   |    94  |         end
# >>                                   |    95  | 
...
# >>        1  (    0.5%)  Bioshogi::PlayerExecutorBase#mediator
# >>        1  (    0.5%)  block in <class:TechniqueMatcherInfo>
# >>        1  (    0.5%)  block in <class:TechniqueMatcherInfo>
# >>        1  (    0.5%)  Bioshogi::TacticInfo.piece_hash_table
# >>   code:
# >>                                   |    13  |     def execute
# >>   111   (12.1%)                   |    14  |       if e = TacticInfo.soldier_hash_table[soldier]
...
# >>                                   |    19  |       end
# >>                                   |    20  | 
# >>     1    (0.1%)                   |    21  |       if executor.mediator.params[:skill_monitor_technique_enable]
# >>                                   |    22  |         # 主に手筋用で戦型チェックにも使える
# >>                                   |    23  |         key = [soldier.piece.key, soldier.promoted, !!executor.drop_hand]
# >>     1    (0.1%)                   |    24  |         if e = TacticInfo.piece_hash_table[key]
