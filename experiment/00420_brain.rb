...
tp brain.fast_score_list.collect { |e| e.merge(hand: e[:hand].to_kif) } # => [{:hand=>"▲２一歩成(22)", :score=>1305, :socre2=>1305, :best_pv=>[], :eval_times=>1, :sec=>2.3e-05}, {:hand=>"▲３二歩打", :score=>200, :socre2=>200, :best_pv=>[], :eval_times=>1, :sec=>7.0e-06}, {:hand=>"▲１二歩打", :score=>200, :socre2=>200, :best_pv=>[], :eval_times=>1, :sec=>6.0e-06}, {:hand=>"▲３三歩打", :score=>200, :socre2=>200, :best_pv=>[], :eval_times=>1, :sec=>6.0e-06}, {:hand=>"▲１三歩打", :score=>200, :socre2=>200, :best_pv=>[], :eval_times=>1, :sec=>6.0e-06}]
# >> |----------------+-------+--------+----------+------------+---------|
