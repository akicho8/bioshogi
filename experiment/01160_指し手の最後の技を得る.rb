...
# 最後の手に技が入っている
container.execute("68銀", executor_class: PlayerExecutor::WithoutMonitor)
container.hand_logs.last.hand                   # => <▲６八銀(79)>
container.hand_logs.last.skill_set.attack_infos # => [<嬉野流>]

container.execute("34歩", executor_class: PlayerExecutor::WithoutMonitor)
container.hand_logs.last.hand                   # => <△３四歩(33)>
container.hand_logs.last.skill_set.attack_infos # => []

container.execute("26歩", executor_class: PlayerExecutor::WithoutMonitor)
