...
container.execute("▲12桂成")
container.opponent_player.executor.captured_soldier # => <Bioshogi::Soldier "△１二玉">
...
container.current_player.brain(diver_class: Diver::NegaScoutDiver).create_all_hands(promoted_only: true).to_a # => [<△２三歩成(22)>]
