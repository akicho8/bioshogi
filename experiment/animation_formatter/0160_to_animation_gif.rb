...
# >> [AnimationGifFormatter] [execute] ffmpeg -v warning -hide_banner -framerate 1000/500 -i _input%04d.png  -y _output1.gif
# >> [AnimationGifFormatter] [execute] elapsed: 2s
# >> [AnimationGifFormatter] -rw-r--r-- 1 ikeda staff 44K  8 25 17:58 _output1.gif
