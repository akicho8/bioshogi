...
bin = info.to_mp4(one_frame_duration: 1.0, tmpdir_remove: true, audio_enable: false)
Pathname("_output.mp4").write(bin) # => 85330
...
# >> |             size | 83.330078 Kibyte                                                                                                     |
# >> |         bit_rate | 52.510000 Kbit/s                                                                                                     |
# >> |      probe_score | 100                                                                                                                  |
