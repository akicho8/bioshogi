...
bin = info.to_mp4(one_frame_duration_sec: 1.0, tmpdir_remove: true, audio_theme_key: :audio_theme_none, media_factory_key: "rmagick")
...
# >> [mp4_formatter] cd /var/folders/9c/_62dfc8502g_d5r05zyfwlxh0000gn/T/d20210820-78451-x1y9ko
# >> [mp4_formatter] [video] 最後に追加するフレーム数(end_frames): 0
# >> [mp4_formatter] [video] 1手当たりの秒数(one_frame_duration_sec): 1.0
# >> [mp4_formatter] [video] move: 0 / 12
# >> [mp4_formatter] [video] move: 10 / 12
# >> [mp4_formatter] [video] 合計フレーム数(frame_count): 13
# >> [mp4_formatter] [video] -rw-r--r-- 1 ikeda staff 29K  8 20 13:24 _input000.png
...
# >> [mp4_formatter] [video] write[begin]: _output1.mp4 (ffmpeg)
# >> [mp4_formatter] [video] [execute] ffmpeg -v warning -hide_banner -framerate 1000/1000 -i _input%03d.png -c:v libx264 -pix_fmt yuv420p -movflags +faststart  -y _output1.mp4
# >> [mp4_formatter] [video] [execute] elapsed: 2s
# >> [mp4_formatter] [video] write[end]: _output1.mp4 (ffmpeg)
# >> [mp4_formatter] [video] -rw-r--r-- 1 ikeda staff 90K  8 20 13:24 _output1.mp4
# >> [mp4_formatter] rm -fr /var/folders/9c/_62dfc8502g_d5r05zyfwlxh0000gn/T/d20210820-78451-x1y9ko
