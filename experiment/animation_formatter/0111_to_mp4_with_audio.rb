...
bin = info.to_mp4(one_frame_duration: 0.5, tmpdir_remove: false, main_volume: 1.0, end_duration: 5, audio_theme_key: "audio_theme_stg", theme_override_params: {acrossfade_duration: 0})
