...
bp = DefenseInfo["四段端玉"].board_parser
tp bp.other_objects_loc_ary           # => {:black=>{"◇"=>[{:place=>#<Warabi::Place ９五>, :prefix_char=>" ", :something=>"◇"}, {:place=>#<Warabi::Place ８五>, :prefix_char=>" ", :something=>"◇"}, {:place=>#<Warabi::Place ７五>, :prefix_char=>" ", :something=>"◇"}], "◆"=>[{:place=>#<Warabi::Place ８六>, :prefix_char=>" ", :something=>"◆"}, {:place=>#<Warabi::Place ７六>, :prefix_char=>" ", :something=>"◆"}]}, :white=>{"◇"=>[{:place=>#<Warabi::Place １五>, :prefix_char=>" ", :something=>"◇"}, {:place=>#<Warabi::Place ２五>, :prefix_char=>" ", :something=>"◇"}, {:place=>#<Warabi::Place ３五>, :prefix_char=>" ", :something=>"◇"}], "◆"=>[{:place=>#<Warabi::Place ２四>, :prefix_char=>" ", :something=>"◆"}, {:place=>#<Warabi::Place ３四>, :prefix_char=>" ", :something=>"◆"}]}}
tp bp.other_objects_loc_ary[:black]   # => {"◇"=>[{:place=>#<Warabi::Place ９五>, :prefix_char=>" ", :something=>"◇"}, {:place=>#<Warabi::Place ８五>, :prefix_char=>" ", :something=>"◇"}, {:place=>#<Warabi::Place ７五>, :prefix_char=>" ", :something=>"◇"}], "◆"=>[{:place=>#<Warabi::Place ８六>, :prefix_char=>" ", :something=>"◆"}, {:place=>#<Warabi::Place ７六>, :prefix_char=>" ", :something=>"◆"}]}
tp bp.other_objects_loc_ary[:black]["◆"] # => [{:place=>#<Warabi::Place ８六>, :prefix_char=>" ", :something=>"◆"}, {:place=>#<Warabi::Place ７六>, :prefix_char=>" ", :something=>"◆"}]
...
puts info.to_kif
# >> |-------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
# >> | black | {"◇"=>[{:place=>#<Warabi::Place ９五>, :prefix_char=>" ", :something=>"◇"}, {:place=>#<Warabi::Place ８五>, :prefix_char=>" ", :something=>"◇"}, {:place=>#<Warabi::Place ７五>, :prefix_char=>" ", :something=>"◇"}], "◆"=>[{:place=>#<Warabi::Place ８六>, :prefix_cha... |
# >> | white | {"◇"=>[{:place=>#<Warabi::Place １五>, :prefix_char=>" ", :something=>"◇"}, {:place=>#<Warabi::Place ２五>, :prefix_char=>" ", :something=>"◇"}, {:place=>#<Warabi::Place ３五>, :prefix_char=>" ", :something=>"◇"}], "◆"=>[{:place=>#<Warabi::Place ２四>, :prefix_cha... |
# >> |-------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
# >> |----+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
# >> | ◇ | [{:place=>#<Warabi::Place ９五>, :prefix_char=>" ", :something=>"◇"}, {:place=>#<Warabi::Place ８五>, :prefix_char=>" ", :something=>"◇"}, {:place=>#<Warabi::Place ７五>, :prefix_char=>" ", :something=>"◇"}] |
# >> | ◆ | [{:place=>#<Warabi::Place ８六>, :prefix_char=>" ", :something=>"◆"}, {:place=>#<Warabi::Place ７六>, :prefix_char=>" ", :something=>"◆"}]                                                                       |
# >> |----+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
# >> |-------+-------------+-----------|
