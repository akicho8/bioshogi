...
info.formatter.container.turn_info.display_turn # => 71
info.formatter.container.turn_info.current_location.key # => :white
info.formatter.container.turn_info.inspect # => "#<71+0:△後手番>"
puts info.to_kif
