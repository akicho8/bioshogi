...
# >> | KifAdapter | ５一角(52)     | ５二       | ５一  | 角    | false    | false           | false        | [{:error_class=>Bioshogi::PromotedPieceToNormalPiece, :message=>"成った状態から成らない状態に戻れません"}, {:error_class=>Bioshogi::CandidateSoldiersNotInclude, :message=>"▲５一馬(52)としましたが５二から５一に移動することはできません"}] |
