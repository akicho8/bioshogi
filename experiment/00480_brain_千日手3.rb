...
# >> 
# >> 先手番
# >> {:hand=>#<▲１三飛成(14)>, :score=>200, :eval_times=>1, :forecast=>[#<▲１三飛成(14)>]}
# >> 指し手: ▲１三飛成(14)
# >> --------------------------------------------------------------------------------
# >> 後手の持駒：なし
# >>   ２ １
...
# >> 
# >> 後手番
# >> {:hand=>#<△２三飛成(21)>, :score=>0, :eval_times=>2, :forecast=>[#<△２三飛成(21)>]}
# >> 指し手: △２三飛成(21)
# >> |----------------------+---|
...
# >> 
# >> 先手番
# >> {:hand=>#<▲２三龍(13)>, :score=>4300, :eval_times=>5, :forecast=>[#<▲２三龍(13)>]}
# >> 指し手: ▲２三龍(13)
# >> |----------------------+---|
# >> | -1771441069522554039 | 1 |
