...
# >> |-------+-------------+------------+-----------+-----------------+--------+----------+----------------+----------------+--------------------------------------------------------------------------------+-------+----------------+---------+---------------+--------------+--------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------|
# >> |--------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
# >> | mi.header | {"先手"=>"alice", "先手の持駒"=>"銀", "先手の囲い"=>"居玉", "後手の囲い"=>"居玉", "先手の戦型"=>"嬉野流", "先手の備考"=>"居飛車, 相居飛車, 相居玉", "後手の備考"=>"角不成, 居飛車, 相居飛車, 相居玉", "手数"=>6, :last_action_kakinoki_word=>"投了", :judgment_message=>"まで6手で後手の勝ち", :error_text=>nil} |
# >> |--------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
