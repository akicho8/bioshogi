...
# >> |------------+----------+----------+------+-------+---------+---------+------------+------+----------+--------+----------------+-------------------+-----------+-----------------+--------+----------+----------------------|
# >> | source     | triangle | point_to | same | piece | motion1 | motion2 | point_from | sign | csa_from | csa_to | csa_basic_name | csa_promoted_name | usi_piece | usi_stroke_mark | usi_to | usi_from | usi_promoted_trigger |
# >> |------------+----------+----------+------+-------+---------+---------+------------+------+----------+--------+----------------+-------------------+-----------+-----------------+--------+----------+----------------------|
# >> | ６八銀左   |          | ６八     |      | 銀    | 左      |         |            |      |          |        |                |                   |           |                 |        |          |                      |
# >> | △６八全   | △       | ６八     |      | 全    |         |         |            |      |          |        |                |                   |           |                 |        |          |                      |
# >> | △６八銀成 | △       | ６八     |      | 銀    |         | 成      |            |      |          |        |                |                   |           |                 |        |          |                      |
