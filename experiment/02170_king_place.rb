...
# xcontainer.player_at(:black).king_place # => nil
# xcontainer.placement_from_preset("平手")
# xcontainer.player_at(:black).king_place # => #<Bioshogi::Place ５九>
# xcontainer.execute("58玉")
# xcontainer.player_at(:black).king_place # => #<Bioshogi::Place ５八>
#
# xcontainer = Xcontainer.new
...
# +---+
# EOT
# xcontainer.player_at(:white).king_place # => #<Bioshogi::Place １一>
# xcontainer.player_at(:black).king_place # => #<Bioshogi::Place １二>
...
+---------+
EOT
evaluator = xcontainer.player_at(:black).evaluator(evaluator_class: Evaluator::Level2)
