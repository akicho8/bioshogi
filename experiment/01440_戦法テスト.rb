...
# >> | カブト美濃           | 囲い/カブト美濃.kif           | [:片美濃囲い, :カブト美濃]                                                         | true   |
...
# >> | 裾固め               | 囲い/裾固め.kif               | [:片美濃囲い, :木村美濃, :裾固め]                                                  | true   |
...
# >> | 松尾流穴熊           | 囲い/松尾流穴熊.kif           | [:舟囲い, :松尾流穴熊, :銀雲雀]                                                    | true   |
...
# >> | 無敵囲い             | 囲い/無敵囲い.kif             | [:舟囲い, :無敵囲い, :銀雲雀]                                                      | true   |
...
# >> | 相筋違い角           | 戦型/相筋違い角.kif           | [:筋違い角, :相筋違い角]                                                           | true   |
...
# >> | 藤井システム         | 戦型/藤井システム.kif         | [:四間飛車, :藤井システム]                                                         | true   |
...
# >> | パンツを脱ぐ         | 手筋/パンツを脱ぐ.kif         | [:パンツを脱ぐ]                                                                    | true   |
...
# >> | 入玉                 | 備考/入玉.kif                 | [:入玉, :相入玉, :入玉, :相入玉]                                                   | true   |
# >> | 居飛車               | 備考/居飛車.kif               | [:居飛車]                                                                          | true   |
# >> | 振り飛車             | 備考/振り飛車.kif             | [:振り飛車]                                                                        | true   |
# >> | 相入玉               | 備考/相入玉.kif               | [:入玉, :相入玉, :入玉, :相入玉]                                                   | true   |
# >> | 大駒全消失           | 備考/大駒全消失.kif           | [:大駒コンプリート, :振り飛車, :大駒全消失]                                        | true   |
# >> | 居玉                 | 備考/居玉.kif                 | []                                                                                 | false  |
# >> | 相居玉               | 備考/相居玉.kif               | []                                                                                 | false  |
# >> | 相居飛車             | 備考/相居飛車.kif             | []                                                                                 | false  |
# >> | 対振り               | 備考/対振り.kif               | [:振り飛車]                                                                        | false  |
# >> | 相振り               | 備考/相振り.kif               | [:振り飛車, :振り飛車]                                                             | false  |
# >> | 対抗型               | 備考/対抗型.kif               | [:振り飛車]                                                                        | false  |
# >> | 大駒コンプリート     | 備考/大駒コンプリート.kif     | [:大駒コンプリート, :振り飛車, :大駒全消失]                                        | true   |
# >> | 駒柱                 | 備考/駒柱.kif                 | [:振り飛車, :駒柱, :振り飛車, :駒柱]                                               | true   |
# >> |----------------------+-------------------------------+------------------------------------------------------------------------------------+--------|
