...
# >> | 振り飛車             | 備考/振り飛車.kif             | [:振り飛車, :対振り, :居玉, :相居玉, :居飛車, :居玉, :相居玉]                      | true   |
# >> | 相入玉               | 備考/相入玉.kif               | [:入玉, :相入玉, :居飛車, :相居飛車, :入玉, :相入玉, :居飛車, :相居飛車]           | true   |
# >> | 大駒全消失           | 備考/大駒全消失.kif           | [:大駒コンプリート, :居飛車, :居玉, :振り飛車, :大駒全消失, :対振り]               | true   |
...
# >> | 対振り               | 備考/対振り.kif               | [:振り飛車, :対振り, :居玉, :相居玉, :居飛車, :居玉, :相居玉]                      | true   |
# >> | 相振り               | 備考/相振り.kif               | [:振り飛車, :相振り, :居玉, :相居玉, :振り飛車, :相振り, :居玉, :相居玉]           | true   |
# >> | 大駒コンプリート     | 備考/大駒コンプリート.kif     | [:大駒コンプリート, :居飛車, :居玉, :振り飛車, :大駒全消失, :対振り]               | true   |
# >> |----------------------+-------------------------------+------------------------------------------------------------------------------------+--------|
