...
tp rows
# >> |------------+----------------+------------+-------+-------+----------+-----------------+----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
# >> | klass      | source         | point_from | point | piece | promoted | promote_trigger | direct_trigger | errors                                                                                                                                                                                     |
# >> |------------+----------------+------------+-------+-------+----------+-----------------+----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
# >> | Ki2Adapter | △１二銀成     |            | １二  | 銀    | true     | true            | false          | [{:klass=>Warabi::DifferentTurnCommonError, :message=>"先手の手番で後手が着手しました"}, {:klass=>Warabi::MovableBattlerNotFound, :message=>"先手の手番で１二に移動できる駒がありません"}] |
# >> | Ki2Adapter | ▲１二銀成     |            | １二  | 銀    | true     | true            | false          | [{:klass=>Warabi::MovableBattlerNotFound, :message=>"先手の手番で１二に移動できる駒がありません"}]                                                                                         |
# >> | KifAdapter | ５一角(52)     | ５二       | ５一  | 角    | false    | false           | false          | [{:klass=>Warabi::PromotedPieceToNormalPiece, :message=>"成った状態から成らない状態に戻れません"}]                                                                                         |
# >> | Ki2Adapter | ▲５五角成     |            | ５五  | 角    | true     | true            | false          | [{:klass=>Warabi::MovableBattlerNotFound, :message=>"先手の手番で５五に移動できる駒がありません"}]                                                                                         |
