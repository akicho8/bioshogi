...
# >> | Bushido::DefenseInfo | 矢倉早囲い           |                |                                                |        2 |
# >> | Bushido::DefenseInfo | 美濃囲い             | 片美濃囲い     | 高美濃囲い ダイヤモンド美濃                    |        5 |
# >> | Bushido::DefenseInfo | 高美濃囲い           | 美濃囲い       |                                                |        5 |
# >> | Bushido::DefenseInfo | 銀冠                 |                |                                                |        3 |
# >> | Bushido::DefenseInfo | 銀美濃               | 片美濃囲い     |                                                |        4 |
# >> | Bushido::DefenseInfo | ダイヤモンド美濃     | 美濃囲い       |                                                |        5 |
# >> | Bushido::DefenseInfo | 木村美濃             |                |                                                |        3 |
# >> | Bushido::DefenseInfo | 片美濃囲い           |                | 美濃囲い 銀美濃 ちょんまげ美濃                 |        4 |
# >> | Bushido::DefenseInfo | ちょんまげ美濃       | 片美濃囲い     | 坊主美濃                                       |        5 |
# >> | Bushido::DefenseInfo | 坊主美濃             | ちょんまげ美濃 |                                                |        4 |
# >> | Bushido::DefenseInfo | 金美濃               |                |                                                |        6 |
...
# >> | Bushido::DefenseInfo | 舟囲い               |                | 箱入り娘                                       |        8 |
# >> | Bushido::DefenseInfo | 居飛車穴熊           |                | 松尾流穴熊                                     |        5 |
# >> | Bushido::DefenseInfo | 松尾流穴熊           | 居飛車穴熊     |                                                |        7 |
# >> | Bushido::DefenseInfo | 銀冠穴熊             |                |                                                |        6 |
# >> | Bushido::DefenseInfo | ビッグ４             |                |                                                |        7 |
# >> | Bushido::DefenseInfo | 箱入り娘             | 舟囲い         |                                                |        4 |
...
# >> | Bushido::AttackInfo  | 一間飛車             |                |                                                |        2 |
# >> | Bushido::AttackInfo  | 一間飛車穴熊         |                |                                                |        2 |
# >> | Bushido::AttackInfo  | 都成流               |                |                                                |        5 |
# >> | Bushido::AttackInfo  | 右四間飛車左美濃     |                |                                                |        5 |
# >> | Bushido::AttackInfo  | 角換わり             |                | 角換わり腰掛け銀 角換わり棒銀 角換わり早繰り銀 |        2 |
# >> | Bushido::AttackInfo  | 角換わり腰掛け銀     | 角換わり       |                                                |        3 |
# >> | Bushido::AttackInfo  | 角換わり棒銀         | 角換わり       |                                                |        1 |
# >> | Bushido::AttackInfo  | 角換わり早繰り銀     | 角換わり       |                                                |       10 |
# >> | Bushido::AttackInfo  | 筋違い角             |                |                                                |        5 |
# >> | Bushido::AttackInfo  | 木村定跡             |                |                                                |       16 |
# >> | Bushido::AttackInfo  | 一手損角換わり       |                |                                                |        0 |
# >> | Bushido::AttackInfo  | 相掛かり             |                |                                                |        9 |
# >> | Bushido::AttackInfo  | 相掛かり棒銀         |                |                                                |        6 |
...
# >> | Bushido::AttackInfo  | 中飛車左穴熊         |                |                                                |        2 |
# >> | Bushido::AttackInfo  | 遠山流               |                |                                                |        1 |
# >> | Bushido::AttackInfo  | 四間飛車             |                |                                                |        1 |
# >> | Bushido::AttackInfo  | 藤井システム         |                |                                                |        6 |
# >> | Bushido::AttackInfo  | 立石流               |                |                                                |        4 |
# >> | Bushido::AttackInfo  | レグスペ             |                |                                                |        3 |
# >> | Bushido::AttackInfo  | 三間飛車             |                | 石田流 早石田                                  |        0 |
# >> | Bushido::AttackInfo  | 石田流               | 三間飛車       |                                                |        3 |
# >> | Bushido::AttackInfo  | 早石田               | 三間飛車       | 升田式石田流                                   |        3 |
...
# >> | Bushido::AttackInfo  | ダイレクト向かい飛車 |                |                                                |        2 |
# >> | Bushido::AttackInfo  | 向かい飛車           |                |                                                |        1 |
# >> | Bushido::AttackInfo  | メリケン向かい飛車   |                |                                                |        5 |
# >> | Bushido::AttackInfo  | 阪田流向飛車         |                |                                                |        2 |
# >> | Bushido::AttackInfo  | 角頭歩戦法           |                |                                                |        2 |
# >> | Bushido::AttackInfo  | 鬼殺し向かい飛車     |                |                                                |        4 |
# >> | Bushido::AttackInfo  | 陽動振り飛車         |                |                                                |        3 |
# >> | Bushido::AttackInfo  | 玉頭銀               |                |                                                |        2 |
# >> | Bushido::AttackInfo  | つくつくぼうし戦法   |                |                                                |        4 |
# >> | Bushido::AttackInfo  | ひねり飛車           |                |                                                |        2 |
# >> | Bushido::AttackInfo  | 相振り飛車           |                |                                                |        1 |
# >> | Bushido::AttackInfo  | 角交換振り飛車       |                |                                                |        0 |
# >> | Bushido::AttackInfo  | きｍきｍ金           |                |                                                |        4 |
...
# >> | Bushido::AttackInfo  | 対振り持久戦         |                |                                                |        1 |
# >> | Bushido::AttackInfo  | 高田流左玉           |                |                                                |        3 |
# >> | Bushido::AttackInfo  | ７二飛亜急戦         |                |                                                |        7 |
# >> | Bushido::AttackInfo  | 袖飛車               |                |                                                |        0 |
# >> | Bushido::AttackInfo  | 一直線穴熊           |                |                                                |        8 |
# >> | Bushido::AttackInfo  | 穴角戦法             |                | 穴角向かい飛車                                 |        0 |
# >> | Bushido::AttackInfo  | 穴角向かい飛車       | 穴角戦法       |                                                |        1 |
# >> |----------------------+----------------------+----------------+------------------------------------------------+----------|
