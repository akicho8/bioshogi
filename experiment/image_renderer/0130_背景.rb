...
parser.image_renderer(bg_file: "#{__dir__}/../../lib/bioshogi/assets/images/matrix.png", color_theme_key: "orange_lcd_mode").display
parser.image_renderer(color_theme_key: "matrix_mode").display
# ~> /Users/ikeda/src/bioshogi/lib/bioshogi/image_renderer.rb:191:in `read': unable to open image `/../../lib/bioshogi/assets/images/matrix.png': No such file or directory @ error/blob.c/OpenBlob/2924 (Magick::ImageMagickError)
