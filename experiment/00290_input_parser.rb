...
# >> |------------+--------------+-----------+----------+-----------+-----------------+--------------+---------------------+--------------------+----------------+----------+----------+--------+-----------+------------------+--------------------+--------+----------+---------------------|
# >> | source     | ki2_location | kif_point | ki2_same | kif_piece | ki2_motion_part | ki2_as_it_is | ki2_promote_trigger | kif_direct_trigger | kif_point_from | csa_sign | csa_from | csa_to | csa_piece | usi_direct_piece | usi_direct_trigger | usi_to | usi_from | usi_promote_trigger |
# >> |------------+--------------+-----------+----------+-----------+-----------------+--------------+---------------------+--------------------+----------------+----------+----------+--------+-----------+------------------+--------------------+--------+----------+---------------------|
# >> | ６八銀左   |              | ６八      |          | 銀        | 左              |              |                     |                    |                |          |          |        |           |                  |                    |        |          |                     |
# >> | △６八全   | △           | ６八      |          | 全        |                 |              |                     |                    |                |          |          |        |           |                  |                    |        |          |                     |
# >> | △６八銀成 | △           | ６八      |          | 銀        |                 |              | 成                  |                    |                |          |          |        |           |                  |                    |        |          |                     |
