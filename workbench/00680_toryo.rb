...
container.current_player.brain(diver_class: AI::Diver::NegaScoutDiver).create_all_hands(promoted_only: true).to_a # => [<△１二玉(11)>, <△２三歩成(22)>]
...
# tp record
# tp AI::Brain.human_format(records)
# container.execute(record[:hand].to_sfen, executor_class: PlayerExecutor::WithoutAnalyzer)
