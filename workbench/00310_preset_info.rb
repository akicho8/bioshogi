...
PresetInfo["十九枚落ち"].sorted_soldiers.collect(&:to_s)       # => ["▲９七歩", "▲９九香", "▲８七歩", "▲８八角", "▲８九桂", "▲７七歩", "▲７九銀", "▲６七歩", "▲６九金", "△５一玉", "▲５七歩", "▲５九玉", "▲４七歩", "▲４九金", "▲３七歩", "▲３九銀", "▲２七歩", "▲２八飛", "▲２九桂", "▲１七歩", "▲１九香"]
...
# >> |       二枚持ち | position sfen lnsgkgsnl/9/ppppppppp/9/9/9/PPPPPPPPP/1B5R1/LNSGKGSNL w RB 1    |
...
# >> |         トンボ | position sfen 4k4/1r5b1/ppppppppp/9/9/9/PPPPPPPPP/1B5R1/LNSGKGSNL w - 1       |
...
# >> |       青空将棋 | position sfen lnsgkgsnl/1r5b1/9/9/9/9/9/1B5R1/LNSGKGSNL b - 1                 |
# >> | バリケード将棋 | position sfen 9/9/ppppppppp/7k1/9/1K7/PPPPPPPPP/9/9 b RBLrbl 1                |
...
# >> | position sfen lnsgkgsnl/9/ppppppppp/9/9/9/PPPPPPPPP/1B5R1/LNSGKGSNL w RB 1    |
...
# >> | position sfen 4k4/1r5b1/ppppppppp/9/9/9/PPPPPPPPP/1B5R1/LNSGKGSNL w - 1       |
...
# >> | position sfen lnsgkgsnl/1r5b1/9/9/9/9/9/1B5R1/LNSGKGSNL b - 1                 |
# >> | position sfen 9/9/ppppppppp/7k1/9/1K7/PPPPPPPPP/9/9 b RBLrbl 1                |
