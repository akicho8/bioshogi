...
V.left_anaguma_vectors   # => [<[0, -1]>, <[1, -1]>, <[1, 0]>, <[0, -2]>, <[1, -2]>, <[2, -2]>, <[2, -1]>, <[2, 0]>]

V.left_anaguma_vectors.collect { |e| e * V.reverse_x } # => [<[0, -1]>, <[-1, -1]>, <[-1, 0]>, <[0, -2]>, <[-1, -2]>, <[-2, -2]>, <[-2, -1]>, <[-2, 0]>]
V.right_anaguma_vectors                                # => [<[0, -1]>, <[-1, -1]>, <[-1, 0]>, <[0, -2]>, <[-1, -2]>, <[-2, -2]>, <[-2, -1]>, <[-2, 0]>]
