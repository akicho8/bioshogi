...
# >> |------------+----------------+------------+-------+-------+----------+-----------------+--------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
# >> | Ki2Adapter | △１二銀成     |            | １二  | 銀    | true     | true            | false        | [{:error_class=>Bioshogi::DifferentTurnCommonError, :message=>"先手の手番で後手が着手しました"}, {:error_class=>Bioshogi::MovableBattlerNotFound, :message=>"先手の手番で１二に移動できる駒がありません"}]                                    |
# >> | Ki2Adapter | ▲１二銀成     |            | １二  | 銀    | true     | true            | false        | [{:error_class=>Bioshogi::MovableBattlerNotFound, :message=>"先手の手番で１二に移動できる駒がありません"}]                                                                                                                                  |
# >> | KifAdapter | ５一角(52)     | ５二       | ５一  | 角    | false    | false           | false        | [{:error_class=>Bioshogi::PromotedPieceToNormalPiece, :message=>"成った状態から成らない状態に戻れません"}, {:error_class=>Bioshogi::SoldierWarpError, :message=>"▲５一馬(52)としましたが５二から５一に移動することはできません"}] |
# >> | Ki2Adapter | ▲５五角成     |            | ５五  | 角    | true     | true            | false        | [{:error_class=>Bioshogi::MovableBattlerNotFound, :message=>"先手の手番で５五に移動できる駒がありません"}]                                                                                                                                  |
...
# >> | SfenAdapter | 1a1b           | １一       | １二  | 飛    | false    | false           | false        | []                                                                                                                                                                                                                                        |
...
# >> | SfenAdapter | 1a1b+          | １一       | １二  | 飛    | true     | true            | false        | []                                                                                                                                                                                                                                        |
# >> | Ki2Adapter | ▲１二銀打     |            | １二  | 銀    | false    | false           | true         | []                                                                                                                                                                                                                                        |
# >> | Ki2Adapter | ▲１二銀       |            | １二  | 銀    | false    | false           | true         | []                                                                                                                                                                                                                                        |
# >> | CsaAdapter | 0012GI         |            | １二  | 銀    | false    | false           | true         | []                                                                                                                                                                                                                                        |
# >> | SfenAdapter | S*1b           |            | １二  | 銀    | false    | false           | true         | []                                                                                                                                                                                                                                        |
# >> |------------+----------------+------------+-------+-------+----------+-----------------+--------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
