...
f(validate_enable: false, ki2_function: false) # => 694.497999997111

# つまり candidate_soldiers メソッドを呼ばないように validate_enable: false, ki2_function: false の両方を指定しないといけない
