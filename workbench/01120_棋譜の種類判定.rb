...
info.pi.final_result.last_action_key               # => {:last_action_key=>"投了", :used_seconds=>nil}
...
EOT
info.class.name                       # => "Bioshogi::Parser::KifParser"
info.pi.move_infos                       # => [{:turn_number=>"1", :input=>"７六歩", :clock_part=>nil, :used_seconds=>nil}, {:turn_number=>"2", :input=>"３四歩", :clock_part=>nil, :used_seconds=>nil}]
