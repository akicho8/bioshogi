...
# >>        674   (5.0%)         188   (1.4%)     Bioshogi::Dimension::DimensionColumn.lookup
# >>        629   (4.7%)         169   (1.3%)     Bioshogi::Dimension::DimensionRow.lookup
...
# >>      674  (   21.1%)  Bioshogi::Dimension::DimensionColumn.lookup
# >>      618  (   19.4%)  Bioshogi::Dimension::DimensionRow.lookup
# >>   code:
# >>                                   |    30  |       def lookup(value)
...
# >>                                   |    40  |           a, b = value
# >>   673    (5.0%)                   |    41  |           x = Dimension::DimensionColumn.lookup(a)
# >>   618    (4.6%)                   |    42  |           y = Dimension::DimensionRow.lookup(b)
# >>                                   |    43  |         when String
# >>                                   |    44  |           a, b = value.chars
# >>     1    (0.0%)                   |    45  |           x = Dimension::DimensionColumn.lookup(a)
# >>                                   |    46  |           y = Dimension::DimensionRow.lookup(b)
