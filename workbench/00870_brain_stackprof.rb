...
# >>        674   (5.0%)         188   (1.4%)     Bioshogi::Dimension::Column.lookup
# >>        629   (4.7%)         169   (1.3%)     Bioshogi::Dimension::Row.lookup
...
# >>      674  (   21.1%)  Bioshogi::Dimension::Column.lookup
# >>      618  (   19.4%)  Bioshogi::Dimension::Row.lookup
# >>   code:
# >>                                   |    30  |       def lookup(value)
...
# >>                                   |    40  |           a, b = value
# >>   673    (5.0%)                   |    41  |           x = Dimension::Column.lookup(a)
# >>   618    (4.6%)                   |    42  |           y = Dimension::Row.lookup(b)
# >>                                   |    43  |         when String
# >>                                   |    44  |           a, b = value.chars
