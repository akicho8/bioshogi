...
module Bushido
  class DefenseInfo
    ...
    memory_record attr_reader: [:wars_code, :parent, :other_parents, :alias_names, :turn_limit, :turn_eq, :teban_eq, :fuganai, :kill_only, :stroke_only, :fu_igai_mottetara_dame, :kaisenmae, :hold_piece_not_in, :hold_piece_in, :hold_piece_count_eq, :hold_piece_eq, :sect_key, :defense_group_info, :sankou_url, :siratama_url, :wikipedia_url] do
      [
