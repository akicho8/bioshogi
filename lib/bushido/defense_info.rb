  ...
  class DefenseInfo
    ...
    memory_record do
      [
        ...
        {wars_code: "109",  key: "金美濃",           parent: "ちょんまげ美濃", other_parents: nil,      alias_names: "大山美濃", turn_limit: nil, turn_eq: nil,  order_key: nil, sente: nil, not_have_pawn: nil, kill_only: nil, stroke_only: false, not_have_anything_except_pawn: nil, cold_war: nil, hold_piece_not_in: nil, hold_piece_in: nil, hold_piece_count_eq: nil, hold_piece_eq: nil,   sect_key: "振り飛車", defense_group_info: "美濃囲い変化形",     sankou_url: "http://mijinko83.blog110.fc2.com/blog-entry-107.html", siratama_url: "http://www5e.biglobe.ne.jp/~siratama/nonframe/syougi/furibisya/kinmino.html",      wikipedia_url: "https://ja.wikipedia.org/wiki/%E7%BE%8E%E6%BF%83%E5%9B%B2%E3%81%84#美濃囲いの派生形・変形"},
