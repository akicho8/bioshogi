  ...
  class DefenseInfo
    ...
    memory_record do
      [
        ...
        {wars_code: nil,    key: "左山囲い",         parent: "elmo囲い",       other_parents: nil,      alias_names: "elmo囲い",   turn_limit: nil, turn_eq: nil,  order_key: nil, sente: nil, not_have_pawn: nil, kill_only: nil, drop_only: false, not_have_anything_except_pawn: nil, cold_war: nil, hold_piece_not_in: nil, hold_piece_in: nil, hold_piece_empty: nil, hold_piece_eq: nil,   sect_key: "居飛車",   defense_group_info: "その他の囲い",     check_method: nil, },
