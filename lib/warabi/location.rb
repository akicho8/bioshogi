...
module Warabi
  class Location
    ...
    memory_record [
      {key: :black, name: "▲", equality_name: "先手", handicap_name: "下手", equality_name2: "先手", handicap_name2: "したて", flip_mark: "▼", varrow: " ", csa_sign: "+", angle: 0,   other_match_chars: ["☗"], to_sfen: "b", normalize_key: :itself, value_sign: +1 },
      {key: :white, name: "△", equality_name: "後手", handicap_name: "上手", equality_name2: "後手", handicap_name2: "うわて", flip_mark: "▽", varrow: "v", csa_sign: "-", angle: 180, other_match_chars: ["☖"], to_sfen: "w", normalize_key: :flip,   value_sign: -1 },
    ]
