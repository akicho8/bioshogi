    ...
    class TechniqueInfo
      ...
      memory_record attr_reader: TagColumnNames do
        [
          ...
          # 飛
          { key: "飛車先交換",   alias_names: nil,   },
          { key: "浮き飛車",     alias_names: nil,  },
          { key: "自陣飛車",     alias_names: nil,   },
          { key: "二枚飛車",     alias_names: nil,   },
          { key: "一間竜",       alias_names: nil,   },

          # 玉
          { key: "端玉",         alias_names: nil,   add_to_opponent: nil,        },
          { key: "ハッチ閉鎖",   alias_names: nil,   add_to_opponent: nil,        },
          { key: "玉飛接近",     alias_names: nil,   add_to_opponent: nil,        },
          { key: "銀冠の小部屋", alias_names: nil,   add_to_opponent: nil,        },
          { key: "裸玉",         alias_names: nil,   add_to_opponent: nil,        },
          { key: "桂頭の玉",     alias_names: nil,   add_to_opponent: nil,        },
          { key: "中段玉",       alias_names: nil,   add_to_opponent: nil,        },
          { key: "双玉接近",     alias_names: nil,   add_to_opponent: "双玉接近", },
