    ...
    class NoteInfo
      ...
      memory_record attr_reader: TagColumnNames do
        [
          ...
          # { key: "手損角交換型",     parent: nil, related_ancestors: nil,  alias_names: nil, turn_limit: nil, turn_eq: nil, order_key: :order_first, has_pawn_then_skip: nil, kill_only: true, drop_only: nil,  has_other_pawn_then_skip: nil,  outbreak_skip: true, kill_count_lteq: nil, hold_piece_not_in: nil, hold_piece_in: nil, hold_piece_empty: nil, hold_piece_eq: "角", op_hold_piece_eq: nil,   add_to_self: nil, add_to_opponent: "手得角交換型", },
