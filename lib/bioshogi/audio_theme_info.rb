...
module Bioshogi
  class AudioThemeInfo
    ...
    memory_record [
      ...
      { key: :audio_theme_dance_chain,               name: "ヘッドスピン→ブレイクビート",    url: nil,                                              author: "",                     audio_part_a: :headspin_long,   audio_part_a_volume: 0.7, audio_part_b: :breakbeat_long_strip, audio_part_b_volume: 1.0, acrossfade_duration: 1,   desc: "",                                          },
      { key: :audio_theme_headspin_only,       name: "ヘッドスピン",                    url: nil,                                              author: "",                     audio_part_a: :headspin_long,   audio_part_a_volume: 0.7, audio_part_b: nil,                   audio_part_b_volume: nil, acrossfade_duration: nil, desc: "",                                          },
      { key: :audio_theme_breakbeat_only,      name: "ブレイクビート",                  url: nil,                                              author: "",                     audio_part_a: :breakbeat_long,  audio_part_a_volume: 1.0, audio_part_b: nil,                   audio_part_b_volume: nil, acrossfade_duration: nil, desc: "",                                          },
