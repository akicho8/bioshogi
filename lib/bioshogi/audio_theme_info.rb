...
module Bioshogi
  class AudioThemeInfo
    ...
    memory_record [
      ...
      { key: :audio_theme_is_headspin_only,       name: "ヘッドスピン",                          source_url: nil,                                              author: nil,                    audio_part_a: :headspin_long,       audio_part_a_volume: 1.0, audio_part_a_duration:  28.05, audio_part_a_loop: true,  audio_part_b: nil,                   audio_part_b_volume: nil, acrossfade_duration: nil, desc: "",                                          },
      ...
      { key: :audio_theme_is_dance_chain,         name: "ヘッドスピン→ブレイクビート",          source_url: nil,                                              author: nil,                    audio_part_a: :headspin_long,       audio_part_a_volume: 1.0, audio_part_a_duration:  28.05, audio_part_a_loop: false, audio_part_b: :breakbeat_long_strip, audio_part_b_volume: 1.0, acrossfade_duration: 1,   desc: "",                                          },
