...
module Bioshogi
  class AudioThemeInfo
    ...
    memory_record [
      ...
      { key: :is_audio_theme_ds8680,             name: "おどれグロッケンシュピール",            source_url: "https://dova-s.jp/bgm/play8680.html",            author: "しゃろう",             audio_part_a: :ds8680,              audio_part_a_volume: 1.0, audio_part_a_duration: 60*3+14, audio_part_a_loop: true, audio_part_b: nil,                   audio_part_b_volume: nil, acrossfade_duration: nil, desc: "", },
      ...
      { key: :is_audio_theme_nc142538,           name: "武蔵",                                  source_url: "https://commons.nicovideo.jp/material/nc142538", author: "yuki",                 audio_part_a: :nc142538,            audio_part_a_volume: 1.0, audio_part_a_duration:  95.66, audio_part_a_loop: true,  audio_part_b: nil,                   audio_part_b_volume: nil, acrossfade_duration: nil, desc: "loop",                                      },
      ...
      { key: :is_audio_theme_ds1245,             name: "流幻",                                  source_url: "https://dova-s.jp/bgm/play1245.html",            author: "かずち",               audio_part_a: :ds1245,              audio_part_a_volume: 1.0, audio_part_a_duration: 96.05,  audio_part_a_loop: true,   audio_part_b: nil,  audio_part_b_volume: nil, acrossfade_duration: nil, desc: nil, },
