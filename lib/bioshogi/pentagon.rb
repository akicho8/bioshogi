...
module Bioshogi
  module Pentagon
    ...
    def turn_pentagon_draw(v:, location:)
      ...
      draw_context do |g|
        g.stroke(turn_pentagon_stroke_color)
        g.stroke_width(turn_pentagon_stroke_width)
        g.fill(turn_pentagon_color(location))
        g.polygon(*pentagon_real_points(v: v, location: location, scale: turn_pentagon_scale))
      end
    end
    ...
    def turn_pentagon_stroke_color
      params[:turn_pentagon_stroke_color] || lattice_color
    end

    def turn_pentagon_stroke_width
      params[:turn_pentagon_stroke_width] || lattice_stroke_width
    end

    def turn_pentagon_color(location)
      params[:turn_pentagon_color][location.key]
    end
