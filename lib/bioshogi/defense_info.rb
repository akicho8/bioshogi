  ...
  class DefenseInfo
    ...
    memory_record do
      [
        ...
        { key: "角換わり右玉",     parent: nil,              other_parents: nil,      alias_names: nil,          turn_limit: nil, turn_eq: nil,  order_key: nil, sente: nil, not_have_pawn: nil, kill_only: nil, drop_only: false, pawn_bishop_have_safe: nil, pawn_have_safe: nil, cold_war: nil, hold_piece_not_in: nil, hold_piece_in: nil, hold_piece_empty: nil, hold_piece_eq: "角",   sect_key: "居飛車",   defense_group_info: "その他の囲い",       technique_matcher_info: nil, },
