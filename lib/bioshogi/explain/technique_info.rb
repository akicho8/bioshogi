  ...
  module Explain
    class TechniqueInfo
      ...
      memory_record [
        ...
        { key: "土下座の歩",   trigger_piece_key: { piece_key: :pawn,   promoted: false, motion: :drop }, parent: nil, other_parents: nil, alternate_name: nil, alias_names: nil, turn_limit: nil, turn_eq: nil, order_key: nil, not_have_pawn: nil, kill_only: nil, drop_only: nil,  pawn_bishop_have_ok: nil, pawn_have_ok: nil, outbreak_skip: nil,  kill_count_lteq: nil,  hold_piece_not_in: nil, hold_piece_in: nil, hold_piece_empty: nil, hold_piece_eq: nil,  },
