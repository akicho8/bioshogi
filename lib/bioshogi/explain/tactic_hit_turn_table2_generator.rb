# -*- compile-command: "ruby -I../.. -rbioshogi -e Bioshogi::Explain::TacticHitTurnTable2Generator.new.generate" -*-

module Bioshogi
  module Explain
    class TacticHitTurnTable2Generator
      def generate
      ...
      def output_file
        Pathname("#{__dir__}/tactic_hit_turn_table2.rb").expand_path
      end
