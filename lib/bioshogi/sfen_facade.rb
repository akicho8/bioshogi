...
module Bioshogi
  class SfenFacade
    ...
    class Setup
      ...
      # @mediator.to_history_sfen                # => "lnsgkgsnl/1r5b1/ppppppppp/9/9/9/PPPPPPPPP/1B5R1/LNSGKGSNL b - 1"
      # @mediator.pieces_set("▲銀△銀銀")
      # puts @mediator
      # @mediator.board.to_sfen          # => "lnsgkgsnl/1r5b1/ppppppppp/9/9/9/PPPPPPPPP/1B5R1/LNSGKGSNL"
      # @mediator.to_history_sfen                # => "lnsgkgsnl/1r5b1/ppppppppp/9/9/9/PPPPPPPPP/1B5R1/LNSGKGSNL b S2s 1"
      # @mediator.execute("▲６八銀")
      # @mediator.hand_logs.last.to_sfen # => "7i6h"
      # @mediator.to_history_sfen                # => "lnsgkgsnl/1r5b1/ppppppppp/9/9/9/PPPPPPPPP/1B1S3R1/LN1GKGSNL w S2s 2"
      # @mediator.execute("△２四銀打")
      # @mediator.hand_logs.last.to_sfen # => "S*2d"
      # @mediator.to_history_sfen                # => "lnsgkgsnl/1r5b1/ppppppppp/7s1/9/9/PPPPPPPPP/1B1S3R1/LN1GKGSNL b Ss 3"
