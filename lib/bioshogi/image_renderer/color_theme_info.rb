  ...
  class ImageRenderer
    class ColorThemeInfo
      ...
      memory_record [
        ...
        { key: :is_color_theme_explosion_yellow,               func: -> e { e.is_color_theme_shogi_extend.merge(**e.swars_like, bg_file: "#{__dir__}/../assets/images/background/explosion_yellow.png", outer_frame_fill_color: "hsla(0,0%,0%,0.3)", **e.lattice_all_set("hsla(0,0%,100%,0.4)")) }, },
        { key: :is_color_theme_explosion_blue,                 func: -> e { e.is_color_theme_shogi_extend.merge(**e.swars_like, bg_file: "#{__dir__}/../assets/images/background/explosion_blue.png",   outer_frame_fill_color: "hsla(0,0%,0%,0.3)", **e.lattice_all_set("hsla(0,0%,100%,0.4)")) }, },
        { key: :is_color_theme_cloud_green,                    func: -> e { e.is_color_theme_shogi_extend.merge(**e.swars_like, bg_file: "#{__dir__}/../assets/images/background/cloud_green.png",      outer_frame_fill_color: "hsla(0,0%,0%,0.3)", **e.lattice_all_set("hsla(0,0%,100%,0.4)")) }, },
        { key: :is_color_theme_cloud_pink,                     func: -> e { e.is_color_theme_shogi_extend.merge(**e.swars_like, bg_file: "#{__dir__}/../assets/images/background/cloud_pink.png",       outer_frame_fill_color: "hsla(0,0%,0%,0.3)", **e.lattice_all_set("hsla(0,0%,100%,0.4)")) }, },
        { key: :is_color_theme_cloud_eva0,                     func: -> e { e.is_color_theme_shogi_extend.merge(**e.swars_like, bg_file: "#{__dir__}/../assets/images/background/cloud_eva0.png",       outer_frame_fill_color: "hsla(0,0%,0%,0.3)", **e.lattice_all_set("hsla(0,0%,100%,0.4)")) }, },
        { key: :is_color_theme_cloud_eva1,                     func: -> e { e.is_color_theme_shogi_extend.merge(**e.swars_like, bg_file: "#{__dir__}/../assets/images/background/cloud_eva1.png",       outer_frame_fill_color: "hsla(0,0%,0%,0.3)", **e.lattice_all_set("hsla(0,0%,100%,0.4)")) }, },
