...
Parser::Base.board_parse(<<~EOT) # => {#<Bushido::Location:0x007fa0408c3628 @attributes={:key=>:black, :name=>"先手", :mark=>"▲", :reverse_mark=>"▼", :other_marks=>["b", "^"], :varrow=>" ", :angle=>0, :code=>0}>=>[{:piece=><Bushido::Piece:70163131487940 歩 pawn>, :point=>#<Bushido::Point:70163120336680 "1一">}], #<Bushido::Location:0x007fa0408c3560 @attributes={:key=>:white, :name=>"後手", :mark=>"▽", :reverse_mark=>"△", :other_marks=>["w"], :varrow=>"v", :angle=>180, :code=>1}>=>[]}
+---+
| 歩|
+---+
EOT

Parser::Base.board_parse(<<~EOT) # => {#<Bushido::Location:0x007fa0408c3628 @attributes={:key=>:black, :name=>"先手", :mark=>"▲", :reverse_mark=>"▼", :other_marks=>["b", "^"], :varrow=>" ", :angle=>0, :code=>0}>=>[], #<Bushido::Location:0x007fa0408c3560 @attributes={:key=>:white, :name=>"後手", :mark=>"▽", :reverse_mark=>"△", :other_marks=>["w"], :varrow=>"v", :angle=>180, :code=>1}>=>[{:piece=><Bushido::Piece:70163131487600 桂 knight>, :point=>#<Bushido::Point:70163120308020 "2一">}, {:piece=><Bushido::Piece:70163131487680 香 lance>, :point=>#<Bushido::Point:70163120304580 "1一">}]}
+------+
|v桂v香|
| ・ ・|
+------+
